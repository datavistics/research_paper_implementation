...
def read_cifar_10(image_width, image_height):
    ...
    batch_1 = __unpickle(data_dir/'cifar_10'/'data_batch_1.pkl')
    batch_2 = __unpickle(data_dir/'cifar_10'/'data_batch_1.pkl')
    batch_3 = __unpickle(data_dir/'cifar_10'/'data_batch_1.pkl')
    batch_4 = __unpickle(data_dir/'cifar_10'/'data_batch_1.pkl')
    batch_5 = __unpickle(data_dir/'cifar_10'/'data_batch_1.pkl')
    test_batch = __unpickle(data_dir/'cifar_10'/'test_batch.pkl')
